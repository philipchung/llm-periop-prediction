# ruff: noqa: E501
# %% [markdown]
# ### Analysis of Experiment: Hospital Admission
#
# Experiment Run:
# python scripts/generate.py --experiment-name=hospital_admission --task=hospital_admission --num-fewshot=5 --num-fewshot=10 --num-fewshot=20 --num-fewshot=50 --num-concurrent=7 --model=gpt-4-1106
# %%
