# ruff: noqa: E501
# %% [markdown]
# ### Analysis of Experiment: Hospital Mortality
#
# Experiment Run:
# python scripts/generate.py --experiment-name=hospital_mortality --task=hospital_mortality --num-fewshot=5 --num-fewshot=10 --num-fewshot=20 --num-fewshot=50 --num-concurrent=7 --model=gpt-4-1106
# %%
