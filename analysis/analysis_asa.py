# ruff: noqa: E501
# %% [markdown]
# ### Analysis of Experiment: ASA Physical Status Classification
#
# Experiment Run:
# python scripts/generate.py --experiment-name=asa --task=asa --num-fewshot=5 --num-fewshot=10 --num-fewshot=20 --num-fewshot=50 --num-concurrent=7 --model=gpt-4-1106
# %%
